...
function New-DatabaseConnectionInformation
{
    ...
    process
    {
        ...
        {
            return New-Object Tenant.SiteMetadata.TrustedConnectionDatabaseConnectionInformation -Property @{
        ...
        if( $PSCmdlet.ParameterSetName -eq "SqlAuthentication" )
        {
            ...
            return New-Object Tenant.SiteMetadata.SqlAuthenticationDatabaseConnectionInformation -Property @{
                DatabaseName    = $DatabaseName
                DatabaseServer  = $DatabaseServer
                ConnectTimeout  = $ConnectTimeout
                Encrypt         = $true
        ...
        {
            return New-Object Tenant.SiteMetadata.ServicePrincipalDatabaseConnectionInformation -Property @{
                DatabaseName    = $DatabaseName
                DatabaseServer  = $DatabaseServer
                ConnectTimeout  = $ConnectTimeout
                Encrypt         = $true
