function Assert-ServiceConnection
{
    ...
    process
    {
        if( -not (Get-ConfigurationSetting -ConfigurationSettingName "DatabaseConnectionInformation") )
        {
        ...
        if( -not (Get-ConfigurationSetting -ConfigurationSettingName "TenantConnectionInformation") )
        {
