...
BEGIN
   ...
   (
      ...
      AuthContextStrength                            nvarchar(500)    NULL,
      ...
      ExcludedBlockDownloadGroupIds                  nvarchar(4000)   NULL,
      ...
      LastSecurityModifiedDate                       datetime2(7)     NULL,
      Lcid                                           int              NULL,
      ...
      RestrictedAccessControlGroups                  nvarchar(4000)   NULL,
